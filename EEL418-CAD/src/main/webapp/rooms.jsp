...
<%@page import="Models.Room"%>
<%@page import="postgreConnection.ParametrosDTO"%>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="/EEL418-CAD/">Minha casa <span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="/EEL418-CAD/rooms.jsp">Meus ambientes</a></li>
            <li><a href="/EEL418-CAD/devices.jsp">Meus dispositivos</a></li>
          </ul>
        </div>

        <div class="col-sm-1 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Cadastrar Ambiente</h1>
        </div>
      ...
      <form class="form-horizontal" role="form" method="GET" action="controller">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" placeholder="Nome do ambiente" class="form-control" name="room_Name">
            </div>
          </div>
...
<tr>
 ...
 <form class="form-horizontal" role="form" method="GET" action="controller">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" placeholder="ID do ambiente" class="form-control" name="idToChange">
            </div>
